FEDORA_VERSION = 32
ARCH = x86_64
KERNEL_VERSION = 5.6.14-300.fc$(FEDORA_VERSION).$(ARCH) #5.6.14-300.fc32.x86_64 #5.8.15-201.fc32.x86_64
NVIDIA_DRIVER_VERSION = 460.32.03
IMAGE ?= fedora
CONTAINER_IMAGE ?= ghcr.io/stackhpc/nvidia-driver-installer
CONTAINER_TAG ?= $(NVIDIA_DRIVER_VERSION)-fedora$(FEDORA_VERSION)
